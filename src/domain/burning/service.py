...
from .sessions import BurnSession
...
try:
    from src.burners.imapi2_audio import IMAPI2AudioBurner, IMAPIUnavailableError
...
if TYPE_CHECKING:
    from src.burners.imapi2_audio import IMAPI2AudioBurner as IMAPI2AudioBurnerType
else:
